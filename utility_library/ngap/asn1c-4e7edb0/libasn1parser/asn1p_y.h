...
#line 115 "asn1p_y.y"
{
	...
	asn1p_expr_type_e	 a_type;	

	asn1p_expr_t		*a_expr;	

	asn1p_constraint_t	*a_constr;	

	enum asn1p_constraint_type_e	a_ctype;

	asn1p_xports_t		*a_xports;	

	struct AssignedIdentifier a_aid;	

	asn1p_oid_t		*a_oid;		

	asn1p_oid_arc_t		 a_oid_arc;	

	struct asn1p_type_tag_s	 a_tag;		

	asn1p_ref_t		*a_ref;		

	asn1p_wsyntx_t		*a_wsynt;	

	asn1p_wsyntx_chunk_t	*a_wchunk;	

	struct asn1p_ref_component_s a_refcomp;	

	asn1p_value_t		*a_value;	

	struct asn1p_param_s	 a_parg;	

	asn1p_paramlist_t	*a_plist;	

	struct asn1p_expr_marker_s a_marker;	

	enum asn1p_constr_pres_e a_pres;	
