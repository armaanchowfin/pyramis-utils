...
oer_type_decoder_f TargetToSource_TransparentContainer_decode_oer;
oer_type_encoder_f TargetToSource_TransparentContainer_encode_oer;
...
per_type_decoder_f TargetToSource_TransparentContainer_decode_aper;
per_type_encoder_f TargetToSource_TransparentContainer_encode_aper;
