...
static asn_oer_constraints_t asn_OER_memb_pDUSessionResourceNotifyTransfer_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_PDUSessionResourceNotifyItem_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PDUSessionResourceNotifyItem, pDUSessionResourceNotifyTransfer),
		...
		0,
		{ &asn_OER_memb_pDUSessionResourceNotifyTransfer_constr_3, &asn_PER_memb_pDUSessionResourceNotifyTransfer_constr_3,  memb_pDUSessionResourceNotifyTransfer_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct PDUSessionResourceNotifyItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_175P103,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
