...
asn_TYPE_member_t asn_MBR_SONConfigurationTransfer_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SONConfigurationTransfer, xnTNLConfigurationInfo),
	...
	{ ATF_POINTER, 1, offsetof(struct SONConfigurationTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_175P152,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_SONConfigurationTransfer_oms_1[] = { 4 };
