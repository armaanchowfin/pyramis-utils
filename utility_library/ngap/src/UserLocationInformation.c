...
asn_TYPE_member_t asn_MBR_UserLocationInformation_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct UserLocationInformation, choice.choice_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_SingleContainer_127P25,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-Extensions"
...
asn_TYPE_descriptor_t asn_DEF_UserLocationInformation = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_UserLocationInformation_constr_1, &asn_PER_type_UserLocationInformation_constr_1, CHOICE_constraint },
