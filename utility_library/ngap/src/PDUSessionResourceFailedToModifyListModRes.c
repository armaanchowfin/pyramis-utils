...
asn_TYPE_descriptor_t asn_DEF_PDUSessionResourceFailedToModifyListModRes = {
	...
	sizeof(asn_DEF_PDUSessionResourceFailedToModifyListModRes_tags_1)
		/sizeof(asn_DEF_PDUSessionResourceFailedToModifyListModRes_tags_1[0]), /* 1 */
	{ &asn_OER_type_PDUSessionResourceFailedToModifyListModRes_constr_1, &asn_PER_type_PDUSessionResourceFailedToModifyListModRes_constr_1, SEQUENCE_OF_constraint },
